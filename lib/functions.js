...
module.exports = function(knex, formatter) {
  var postgis = {
    ...
    distance: function(a, b, spheroid) {
      if (typeof spheroid !== 'undefined') {
        return knex.raw('ST_Distance(?, ?, ?)', [
          formatter.wrapWKT(a),
          formatter.wrapWKT(b),
    ...
    within: function(a, b) {
      return knex.raw('ST_Within(?, ?)', [formatter.wrapWKT(a), formatter.wrapWKT(b)]);
    },
